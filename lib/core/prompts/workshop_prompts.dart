...
String getStudyGuideAndQuizPrompt(
    ...
    String? selectedExam,
    String difficulty,
    int attemptCount, // YENİ: Deneme sayısı parametresi eklendi
    ) {
  ...
  if (difficulty == 'hard') {
    ...
    // YENİ: Deneme sayısı 1'den büyükse, yapay zekaya ek bir emir veriliyor.
    if (attemptCount > 1) {
      ...
      **JSON ÇIKTI FORMATI (KESİNLİKLE UYULACAK):**
      {
        ...
        "quiz": [
          {"question": "Soru 1", "options": ["A", "B", "C", "D"], "correctOptionIndex": 0, "explanation": "Doğru cevap A'dır çünkü... B seçeneği ise şu yüzden çeldiricidir..."},
          {"question": "Soru 2", "options": ["A", "B", "C", "D"], "correctOptionIndex": 2, "explanation": "Burada dikkat edilmesi gereken en önemli nokta... Bu nedenle C doğrudur."},
          {"question": "Soru 3", "options": ["A", "B", "C", "D"], "correctOptionIndex": 1, "explanation": "Bu soruda kullanılan formül... B seçeneğini doğrulamaktadır."},
          {"question": "Soru 4", "options": ["A", "B", "C", "D"], "correctOptionIndex": 3, "explanation": "D seçeneği doğrudur. Öğrenciler genellikle A seçeneğindeki tuzağa düşerler, çünkü..."},
          {"question": "Soru 5", "options": ["A", "B", "C", "D"], "correctOptionIndex": 0, "explanation": "Açıklama metni..."}
        ]
      }
    """;
}