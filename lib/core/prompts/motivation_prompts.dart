...
String getMotivationPrompt(
  ...
  if (promptType == 'welcome') {
    ...
    promptContext = "Kullanıcı yeni bir deneme ekledi ve bu deneme ortalamasının altında ($avgNet). Moralinin bozuk olduğunu varsayabilirsin.";
  } else if (promptType == 'new_test_good') {
    promptContext = "Kullanıcı yeni bir deneme ekledi ve bu deneme ortalamasının üstünde ($avgNet). Onu kutlayabilirsin.";
  ...
  - Ortalama Net: $avgNet
  - Günlük Seri: Bilgi yok
  - En Güçlü Konu: Bilgi yok
  - En Zayıf Konu: Bilgi yok
  """;
...
String getQuantumMotivationPrompt({
  ...
  return """
    ...
    - Kullanıcının Quantum Ruh Hali: $quantumMood
    - Duygusal Durum: $emotion
